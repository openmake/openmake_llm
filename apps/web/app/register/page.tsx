    ...
    <div className="grid min-h-dvh place-items-center bg-app px-4">
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <label className="block text-xs font-medium text-fg-2">{t("nameLabel")}</label>
          <input
            type="text"
            required
            value={username}
          ...
          <label className="mt-4 block text-xs font-medium text-fg-2">{t("emailLabel")}</label>
          <input
            type="email"
            required
            value={email}
          ...
          <label className="mt-4 block text-xs font-medium text-fg-2">{t("birthDateLabel")}</label>
          <input
            type="date"
            required
            value={birthDate}
