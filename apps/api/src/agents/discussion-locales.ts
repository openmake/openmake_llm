...
export const DISCUSSION_ERROR_MESSAGES: Record<PromptLocaleCode, {
    ...
    ko: {
        ...
        connectionErrorDetail: [
            ...
            '',
            '**가능한 원인:**',
            '- LLM 추론 서버(vLLM/LiteLLM)에 접속할 수 없습니다.',
    ...
    en: {
        ...
        connectionErrorDetail: [
            ...
            '',
            '**Possible causes:**',
            '- Unable to connect to the LLM inference server (vLLM/LiteLLM).',
    ...
    ja: {
        ...
        connectionErrorDetail: [
            ...
            '',
            '**考えられる原因:**',
            '- LLM 推論サーバー（vLLM/LiteLLM）に接続できません。',
    ...
    es: {
        ...
        connectionErrorDetail: [
            ...
            '',
            '**Posibles causas:**',
            '- No se puede acceder al servidor de inferencia LLM (vLLM/LiteLLM).',
    ...
    de: {
        ...
        connectionErrorDetail: [
            ...
            '',
            '**Mögliche Ursachen:**',
            '- Verbindung zum LLM-Inferenzserver (vLLM/LiteLLM) nicht möglich.',
    ...
    fr: {
        ...
        connectionErrorDetail: [
            ...
            '',
            '**Causes possibles :**',
            '- Impossible d\'accéder au serveur d\'inférence LLM (vLLM/LiteLLM).',
