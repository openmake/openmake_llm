 ...
 * - planner:  멀티모달 오케스트레이터 계획(services/orchestrator/planner — 매 턴 1회 JSON, 작고 빠른 모델 권장)
 *
 ...
 */
export type ModelRole = 'chat' | 'agent' | 'judge' | 'research' | 'spawn' | 'review' | 'router' | 'summary' | 'planner';
 ...
 */
export const USER_ASSIGNABLE_MODEL_ROLES: ReadonlyArray<ModelRole> = ['agent', 'judge', 'research', 'spawn', 'review', 'summary', 'planner'];
