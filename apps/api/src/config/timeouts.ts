...
export const LLM_TIMEOUTS = {
     ...
     *
     * 보고서 프롬프트는 분석 3000~5000 words 를 요구하는 **의도된 장문**이라
     ...
     * env override: REPORT_GENERATION_TIMEOUT_MS
     */
    REPORT_GENERATION_TIMEOUT_MS: Number(process.env.REPORT_GENERATION_TIMEOUT_MS) || 2400000,
} as const;
