...
const NAV_ITEMS = {
    menu: [
        ...
        { href: '/skill-library.html', icon: '📦', iconify: 'lucide:package', label: '스킬 라이브러리', requireAuth: true, minTier: 'pro', cssFiles: ['/css/skill-library.css?v=2'], excludeFromSidebar: true },
