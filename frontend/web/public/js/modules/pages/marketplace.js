    ...
    window.PageModules['marketplace'] = {
        ...
        cleanup: function() {
            ...
            // Remove onclick-exposed globals
                try { delete window.marketplaceSwitchTab; } catch(e) {}
