...
'use strict';
    ...
    window.PageModules['custom-agents'] = {
        ...
        async function submitAgentImport() {
            ...
            const btn = document.getElementById('btnSubmitAgentImport');
            if (btn) { btn.disabled = true; btn.dataset.origText = btn.innerHTML; btn.innerHTML = '⏳ 가져오는 중...'; }
            try {
                const res = await window.authFetch(API_ENDPOINTS.AGENTS_CUSTOM_IMPORT_FROM_GIT, {
                    method: 'POST',
        ...
        loadAgents();
            ...
            // Expose onclick-referenced functions globally
                ...
                window.openAgentImport = openAgentImport;
                window.closeAgentImport = closeAgentImport;
                window.submitAgentImport = submitAgentImport;
            } catch(e) {
        ...
        cleanup: function() {
            ...
            // Remove onclick-exposed globals
                ...
                try { delete window.openAgentImport; } catch(e) {}
                try { delete window.closeAgentImport; } catch(e) {}
                try { delete window.submitAgentImport; } catch(e) {}
        }
    };
