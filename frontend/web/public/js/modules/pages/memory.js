...
'use strict';
    ...
    window.PageModules['memory'] = {
        ...
        function renderMems() {
            ...
            el.innerHTML = filtered.map(m => {
                ...
                <div class="mem-card" onclick="openMem('${m.id}')">
                    ...
                    <div class="mem-meta">
                        ...
                        <span class="importance-bar"><span class="importance-fill" data-width="${imp*10}" data-bg="${impColor(imp)}"></span></span>
            ...
            el.querySelectorAll('.importance-fill[data-width]').forEach(node => {
                node.style.width = node.dataset.width + '%';
                node.style.background = node.dataset.bg;
            });
        }
