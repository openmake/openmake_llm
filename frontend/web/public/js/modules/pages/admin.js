        ...
        init: function () {
            ...
            try {
                ...
                function switchTab(tab) {
                    ...
                    var userStatsScopeLabel = document.getElementById('userStatsScopeLabel');
                    if (userStatsScopeLabel) userStatsScopeLabel.style.display = (tab === 'users') ? 'inline-flex' : 'none';
