...
'use strict';
    ...
    window.PageModules['admin'] = {
         ...
         */
        init: function () {
            // Phase R2: admin 섹션 탭 클릭 → SPA 라우터로 navigate
            document.querySelectorAll('.admin-section-tab[data-navigate]').forEach(function (btn) {
