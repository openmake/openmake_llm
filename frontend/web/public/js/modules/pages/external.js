...
'use strict';
    ...
    window.PageModules['external'] = {
        ...
        init: function() {
            try {
                const SERVICES = [
            { type:'google_drive', label:'Google Drive', icon:'<iconify-icon icon=lucide:hard-drive></iconify-icon>' },
            { type:'notion', label:'Notion', icon:'<iconify-icon icon=lucide:book></iconify-icon>' },
            { type:'github', label:'GitHub', icon:'<iconify-icon icon=lucide:github></iconify-icon>' },
            { type:'slack', label:'Slack', icon:'<iconify-icon icon=lucide:message-square></iconify-icon>' },
            { type:'dropbox', label:'Dropbox', icon:'<iconify-icon icon=lucide:box></iconify-icon>' }
        ];
        let connections = [];
