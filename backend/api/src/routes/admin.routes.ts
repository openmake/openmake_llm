/**
 * ============================================================
 * Admin Routes - 관리자 전용 사용자 관리 API
 * ============================================================
 */
...
export function createAdminRouter(): Router {
    ...
    router.get('/conversations/export', async (req: Request, res: Response) => {
        try {
            const pool = getPool();
...
<<<<<<< HEAD:backend/api/src/routes/admin.routes.ts
    return router;
=======
    /**
...
>>>>>>> fbe49389978ecfeb4fc6d2df399c18138a7fed78:backend/api/src/controllers/admin.controller.ts
}
