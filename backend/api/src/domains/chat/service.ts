 ...
 */
<<<<<<< HEAD:backend/api/src/domains/chat/service.ts
...
import { getPromptConfig } from './pipeline/prompt';
...
import { preRequestCheck, postResponseCheck } from './pipeline/security-hooks';
import { 
    determineLanguagePolicy,
    type SupportedLanguageCode,
    type LanguagePolicyDecision
} from './pipeline/language-policy';
...
>>>>>>> fbe49389978ecfeb4fc6d2df399c18138a7fed78:backend/api/src/services/ChatService.ts
...
>>>>>>> fbe49389978ecfeb4fc6d2df399c18138a7fed78:backend/api/src/services/ChatService.ts
        ...
        if (history && history.length > 0) {
            ...
            try {
                const { summarizeHistory } = await import('./pipeline/history-summarizer');
