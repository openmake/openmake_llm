...
const SECTION_LABELS: Record<PromptLocaleCode, {
    persona: string;
    expertise: string;
...
const FORMAT_DESCRIPTIONS: Record<PromptLocaleCode, Record<string, string>> = {
    ko: {
...
const SOFT_INTERLOCK_CONTENT: Record<PromptLocaleCode, {
    processIntro: string;
    steps: string[];
...
const FINAL_REMINDER_CONTENT: Record<PromptLocaleCode, {
    languageRule: string;
...
const PRESET_CONTENT: Record<PromptLocaleCode, PresetContentData> = {
    ko: {
        assistant: {
    ...
    en: {
        assistant: {
            ...
            traits: [
                ...
                'Use emojis appropriately to express friendliness'
            ],
        ...
        coder: {
            ...
            traits: [
                'Write production-grade safe code',
        ...
        reasoning: {
            ...
            expertise: [
                ...
                'Mathematical calculation and comparison',
                'Decision making and trade-off analysis'
            ],
            traits: [
                'Apply Chain of Thought to all problems',
                'Clearly explain the logic at each step',
                'Transparently present the process of reaching conclusions'
            ],
    ...
    es: {
        assistant: {
            ...
            traits: [
                'Usar un tono cálido y accesible',
                'Explicar términos difíciles de forma sencilla',
                'Usar emojis apropiadamente para expresar cercanía'
            ],
        ...
        coder: {
            ...
            traits: [
                'Escribir código seguro de nivel de producción',
                'Considerar manejo de errores y casos límite',
                'Diseñar con enfoque en optimización del rendimiento'
            ],
        ...
        reasoning: {
            ...
            expertise: [
                'Descomposición y análisis de problemas complejos',
                'Razonamiento lógico paso a paso',
                'Cálculo y comparación matemática',
                'Toma de decisiones y análisis de compensaciones'
            ],
            traits: [
                'Aplicar Chain of Thought a todos los problemas',
                'Explicar con claridad la lógica en cada paso',
                'Presentar de forma transparente el proceso para llegar a conclusiones'
            ],
    ...
    de: {
        assistant: {
            ...
            traits: [
                'Verwenden Sie einen warmen und zugänglichen Ton',
                'Erklären Sie schwierige Begriffe in einfacher Sprache',
                'Verwenden Sie Emojis angemessen, um Freundlichkeit auszudrücken'
            ],
        ...
        coder: {
            ...
            traits: [
                'Schreiben Sie sicheren Code auf Produktionsniveau',
                'Berücksichtigen Sie Fehlerbehandlung und Randfälle',
                'Entwerfen Sie mit Blick auf Leistungsoptimierung'
            ],
        ...
        reasoning: {
            ...
            expertise: [
                'Zerlegung und Analyse komplexer Probleme',
                'Schrittweise logische Schlussfolgerung',
                'Mathematische Berechnung und Vergleich',
                'Entscheidungsfindung und Trade-off-Analyse'
            ],
            traits: [
                'Wenden Sie Chain of Thought auf alle Probleme an',
                'Erklären Sie die Logik in jedem Schritt klar',
                'Stellen Sie den Prozess zur Schlussfolgerung transparent dar'
            ],
    ...
    fr: {
        assistant: {
            ...
            traits: [
                'Utilisez un ton chaleureux et accessible',
                'Expliquez les termes complexes en langage simple',
                'Utilisez des emojis de manière appropriée pour exprimer la convivialité'
            ],
        ...
        coder: {
            ...
            traits: [
                'Écrivez du code sécurisé de niveau production',
                'Prenez en compte la gestion des erreurs et les cas limites',
                'Concevez en tenant compte de l\'optimisation des performances'
            ],
        ...
        reasoning: {
            ...
            expertise: [
                'Décomposition et analyse de problèmes complexes',
                'Raisonnement logique étape par étape',
                'Calcul mathématique et comparaison',
                'Prise de décision et analyse des compromis'
            ],
            traits: [
                'Appliquez la chaîne de pensée à tous les problèmes',
                'Expliquez clairement la logique à chaque étape',
                'Présentez le processus de raisonnement de manière transparente'
            ],
